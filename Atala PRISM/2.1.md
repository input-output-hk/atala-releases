...
* [Atala PRISM Wallet SDK Swift](https://github.com/input-output-hk/atala-prism-wallet-sdk-swift/releases/tag/2.0.1)
* [Atala PRISM Wallet SDK TypeScript](To be released)
